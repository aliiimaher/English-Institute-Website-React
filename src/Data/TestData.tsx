...
import thisSvg from "../assets/Pic/CourseInfo/learn-english-design-vector-course-info.svg";
import thisTeacherPng from "../assets/Pic/CourseInfo/usof.png";
...
const courseData: CourseData = {
  ...
  price: "۳۰۰,۰۰۰ تومان",
  teacher: "یوسف اسدی",
  teacherPicturePath: thisTeacherPng,
  teacherDescription:
    "لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ، و با استفاده از طراحان گرافیک است، چاپگرها و متون بلکه روزنامه و مجله در ستون و سط آنچنان که لازم است.",
...
<div className="course-info-up-side-left-hand-course-sub-info-items-questions">
  ...
  <div className="course-info-up-side-left-hand-course-sub-info-items">
    ...
    <div style={{ fontFamily: "KalamehThin" }}>تعداد ویدیو:</div>
  </div>
  <div className="course-info-up-side-left-hand-course-sub-info-items">
  ...
  <div className="course-info-up-side-left-hand-course-sub-info-items">
    ...
    <div style={{ fontFamily: "KalamehThin" }}>تعداد دانشجو:</div>
  </div>
</div>
<div className="course-info-up-side-left-hand-course-sub-info-items-answers">
  <div>{thisCourse.teacher}</div>
  <div>{thisCourse.numberOfSessions}</div>
